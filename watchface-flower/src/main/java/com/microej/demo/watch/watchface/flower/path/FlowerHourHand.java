...
/**
 * A vector graphics that represents the hour hand of the flower watchface.
 */
public class FlowerHourHand extends Hand {
	 ...
	 */
	public FlowerHourHand() {
		super(VectorImage.getImage("/images/flower_hour.xml"), X_OFFSET, Y_OFFSET); //$NON-NLS-1$
	}
}
