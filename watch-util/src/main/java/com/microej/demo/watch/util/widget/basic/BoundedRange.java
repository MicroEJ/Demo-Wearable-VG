...
import com.microej.demo.watch.util.widget.basic.model.BoundedRangeModel;
...
public abstract class BoundedRange extends Widget {
	...
	/**
	 * Updates the bounded range's current value to the given value without requesting a render of this widget. This
	 * method forwards the new value to the model. The data model (an instance of BoundedRangeModel) handles any
	 * mathematical issues arising from assigning faulty values. If the new value is different from the previous value,
	 * the change listener is notified.
	 *
	 * @param value
	 *            the new value.
	 */
